/**
 * Frontend mock fixtures (cycle 1).
 *
 * Mirrors MOCK_DATA.md verbatim for the offline frontend session. Replaced by
 * `/api/cases/[id]/events` (cached) + `/api/extract` (live) in a later cycle.
 */
import type { CaseFixture } from "./schema";

export const CASE1_FIXTURE: CaseFixture = {
  case_id: "case1",
  ...
  events: [
    {
      ...
      related_ids: [
        "c1000001-0000-4000-8001-000000000002",
        "c1000001-0000-4000-8001-000000000003",
        "c1000001-0000-4000-8001-000000000004",
      ],
    },
    {
      ...
      related_ids: [
        "c1000001-0000-4000-8001-000000000005",
        "c1000001-0000-4000-8001-000000000008",
      ],
    },
    {
      ...
      summary:
        "Type 2 diabetes added to the active problem list based on elevated HbA1c and presenting symptoms.",
      severity: "concerning",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
    ...
    },
    {
      ...
      summary:
        "Metformin 500 mg twice daily started as first-line therapy. Patient counseled on titration plan over the next two weeks.",
      severity: "monitor",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
      ...
      related_ids: [
        "c1000001-0000-4000-8001-000000000007",
        "c1000001-0000-4000-8001-000000000010",
      ],
    },
    {
      ...
      title: "HbA1c — 8.4%",
      summary:
        "A1c improving but still above goal of 7%. Patient reports good adherence to metformin.",
      severity: "monitor",
      values: {
        key: "HbA1c",
        value: "8.4",
    ...
    },
    {
      ...
      summary:
        "Reviewed three-month A1c. Patient adherent to metformin without GI side effects. Plan to titrate dose for tighter glycemic control.",
      severity: "info",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
    ...
    },
    {
      ...
      summary:
        "Metformin titrated up from 500 mg to 1000 mg twice daily based on suboptimal A1c.",
      severity: "monitor",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
    ...
    },
    {
      ...
      title: "HbA1c — 7.2%",
      summary:
        "A1c continues to improve, approaching goal range. Patient demonstrating sustained response to dose increase.",
      severity: "monitor",
      values: {
        key: "HbA1c",
        value: "7.2",
      ...
      related_ids: [
        "c1000001-0000-4000-8001-000000000002",
        "c1000001-0000-4000-8001-000000000005",
        "c1000001-0000-4000-8001-000000000011",
      ],
    },
    {
      ...
      summary:
        "A1c stable. Discussed Mediterranean dietary pattern and walking program. Patient agreeable to lifestyle modifications.",
      severity: "info",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
    ...
    },
    {
      ...
      summary:
        "Regimen continued. Note: medication list reflects 850 mg b.i.d., a discrepancy with the May visit's 1000 mg b.i.d. titration. Worth confirming with patient at next visit.",
      severity: "monitor",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
    ...
    },
    {
      ...
      title: "HbA1c — 6.9%",
      summary:
        "A1c at goal for the first time. Sustained glycemic control over 15 months of treatment.",
      severity: "info",
      values: {
        key: "HbA1c",
        value: "6.9",
    ...
    },
    {
      ...
      summary:
        "LDL cholesterol borderline elevated. Discussion priority for next visit; may warrant statin consideration in the context of T2D.",
      severity: "monitor",
      values: {
        key: "LDL",
        value: "145",
    ...
    },
    {
      ...
      summary:
        "Routine annual visit. T2D well controlled. Discussed LDL elevation from April labs and agreed on lifestyle-first approach with recheck in six months.",
      severity: "info",
      values: null,
      provider: "Sarah Levy, MD",
      source: {
...
export const CASE2_FIXTURE: CaseFixture = {
  case_id: "case2",
  ...
  events: [
    {
      ...
      summary:
        "Routine annual gynecologic visit. Breast and pelvic exams unremarkable. Screening mammogram ordered as routine.",
      severity: "info",
      values: null,
      ...
      related_ids: [
        "c2000002-0000-4000-8002-000000000002",
        "c2000002-0000-4000-8002-000000000003",
      ],
    },
    {
      ...
      summary:
        "Routine screening mammogram ordered through breast imaging center.",
      severity: "info",
      values: null,
      provider: "Karen Wu, MD",
      source: {
    ...
    },
    {
      ...
      summary:
        "Screening mammogram identified a suspicious mass in the right breast at the 11 o'clock position. BI-RADS category 4 — biopsy recommended.",
      severity: "concerning",
      values: null,
    ...
    },
    {
      ...
      summary:
        "Referred to breast surgery for biopsy and surgical evaluation following BI-RADS 4 mammogram finding.",
      severity: "concerning",
      values: null,
      provider: "Karen Wu, MD",
      source: {
        ...
        page: 1,
        snippet:
          "Refer to Dr. Patel, Breast Surgery, for evaluation of suspicious mass r/o malignancy.",
      },
      related_ids: [],
    },
    {
      ...
      summary:
        "Surgical consultation. Reviewed mammogram findings with patient. Core needle biopsy planned for following week.",
      severity: "concerning",
      values: null,
    ...
    },
    {
      ...
      summary:
        "Image-guided core needle biopsy of right breast lesion scheduled.",
      severity: "concerning",
      values: null,
      provider: "Anil Patel, MD",
      source: {
    ...
    },
    {
      ...
      summary:
        "Image-guided core needle biopsy of the right breast mass returned benign — fibroadenoma. No evidence of malignancy.",
      severity: "info",
      values: null,
      provider: "Anil Patel, MD",
      source: {
      ...
      related_ids: [
        "c2000002-0000-4000-8002-000000000003",
        "c2000002-0000-4000-8002-000000000006",
      ],
    },
    {
      ...
      summary:
        "Follow-up to discuss benign biopsy result with patient. Reassurance provided. Routine screening interval recommended going forward.",
      severity: "info",
      values: null,
      provider: "Karen Wu, MD",
      source: {
...
/** Case 3 is SHAPE-MOCK ONLY (per MOCK_DATA.md). Used to render the bullet-list
 *  rendering path; it is NOT extraction output and MUST NOT inform any prompt. */
export const CASE3_FIXTURE: CaseFixture = {
  case_id: "case3",
  ...
  events: [
    {
      ...
      source: {
        ...
        page: 1,
        snippet:
          "MOCK ONLY — not actual extraction output. Used for /eval UI scaffolding only.",
      },
      related_ids: [],
    },
    {
